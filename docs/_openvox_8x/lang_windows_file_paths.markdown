...
* If you are using **Puppet 3.7.3 or later,** use [the `$system32` fact](/openfact/latest/core_facts.html#system32) whenever you need to access the `system32` directory. Easy and reliable.
